...
Como mejora, el modelo incorpora early stopping y checkpoints para optimizar su rendimiento. La evaluación del desempeño se realizó mediante una matriz de confusión y métricas como precisión, recall y f1-score por clase, junto con la accuracy global, utilizando la función classification_report de sklearn. 
...
Para este estudio, se optó específicamente por la técnica de reemplazo por sinónimos utilizando WordNet, una exhaustiva base de datos léxica del inglés. Esta técnica sustituye determinadas palabras en un texto por sus sinónimos correspondientes. 

De acuerdo con Wei y Zou, el número de palabras a reemplazar se determina mediante un parámetro α multiplicado por la longitud del texto. Este método preserva el significado esencial del contenido mientras genera variaciones que contribuyen a mejorar la capacidad de generalización del modelo.
...
![Captura de pantalla 2025-04-29 232426](https://github.com/user-attachments/assets/f2c8e5e4-c1fa-4bf0-b74d-f40196fb0b62)


*Métricas por cada clase analizada, mostrando solo algunas clases representativas.*

![Captura de pantalla 2025-04-29 232446](https://github.com/user-attachments/assets/f8a90598-67ce-42b1-98e6-9d9c97923000)

*Evolución del accuracy y loss global del modelo en su versión final durante una ejecución de 5 episodios.*


![Captura de pantalla 2025-04-29 232522](https://github.com/user-attachments/assets/ca8e0208-923e-48dd-83b3-d3de7fbf49d5)
...
![Captura de pantalla 2025-04-29 232609](https://github.com/user-attachments/assets/aa678ae0-96c6-452e-90d9-960768fe158d)

*Resumen de clasificación con número de aciertos correctos e incorrectos.*

![Captura de pantalla 2025-04-29 232627](https://github.com/user-attachments/assets/0d77d969-f380-4659-89b1-334de86945a0)

*Matriz detallada de falsos positivos, falsos negativos, verdaderos positivos y verdaderos negativos.*

![image](https://github.com/user-attachments/assets/528cd417-e1eb-4a77-8244-ff38ca64d6d0)

*El modelo alcanzó un accuracy global máximo de 0.8 en el conjunto de validación durante una ejecución de 50 epochs.*
...
![Captura de pantalla 2025-04-29 232356](https://github.com/user-attachments/assets/27f8a2d6-9bd9-4946-8f45-bce918aa1e2d)


*Resultado de la predicción interactiva mostrando la clasificación del titular ejemplo con su correspondiente nivel de confianza.*
